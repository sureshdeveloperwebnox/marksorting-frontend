    ...
    return (
        <div ref={containerRef} className="relative">
            ...
            <button
                ...
                data-filled={selectedCustomers.length > 0}
                className={cn(
                    'w-full min-h-[44px] px-3 py-2 text-left rounded-xl outline-none focus:ring-2 focus:ring-primary/20 transition-all duration-200 flex items-start gap-2 flex-wrap',
