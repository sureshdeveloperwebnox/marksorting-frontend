...
import { ServiceCategoryFormDrawer } from "@/components/forms/service-category-form-drawer";
...
export default function ServiceCategoryPage() {
    ...
    /* ── Render ── */
    return (
        <RouteGuard module="service_categories" action="view">
        <motion.div
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 pb-5 border-b border-gray-100 dark:border-white/5">
                        <div>
                            ...
                            <p className="text-sm text-gray-400 dark:text-gray-500 font-medium mt-0.5">
                                Manage all service categories and their details
                            </p>
                        </div>
