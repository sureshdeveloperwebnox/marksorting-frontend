...
export default function MasterMillsPage() {
  ...
  const columnConfig: ColumnConfig[] = [
    ...
    { key: "warranty_months", header: "Warranty Period (Months)" },
    { key: "amc_starting_date", header: "AMC Starting Date" },
    { key: "amc_closing_date", header: "AMC Closing Date" },
    { key: "amc_period", header: "AMC Period (Months)" },
    ...
    return [
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: "Mfg Date",
            value: formatDateSafe(viewMillData.mfg_date),
            icon: Calendar,
          },
        ],
      },
